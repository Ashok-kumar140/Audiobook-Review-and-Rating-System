        ...
        <div className="min-h-[calc(100vh-3.5rem)] grid place-items-center">
            {loading ? (
                ...
                <div className="max-w-[500px] p-4 lg:p-8">
                    ...
                    <p className="text-[1.125rem] leading-[1.625rem] my-4 text-gray-900">
                        ...
                        <OtpInput
                            ...
                            renderInput={(props) => (
                                <input
                                    ...
                                    className="w-[48px] lg:w-[60px] border-0 bg-gray-400 rounded-[0.5rem] text-black aspect-square text-center focus:border-0 focus:outline-2 focus:outline-black"
                                />
                            )}
                            containerStyle={{
                    ...
                    <div className="mt-6 flex items-center justify-between">
                        ...
                        <button
                            className="flex items-center text-gray-800 gap-x-2"
